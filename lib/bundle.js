...
class Game {
  ...
  addTitle() {
    ...
    underline.graphics.beginFill('#FFB23B').drawRect(77, 105, 470, 5);
...
class Round {
  constructor(board) {
    ...
    this.bullets = 3;
    this.bulletsSprite = this.createBullets();
  ...
  startRound() {
    ...
    this.roundContainer.addChild(this.bullets);
