...
class Round {
  ...
  renderRoundInfo(roundNumber) {
    const score = new createjs.Text(`R=${roundNumber}`, "14px 'Press Start 2P'", '#93e473');
    score.x = 68;
    score.y = 390;
    this.roundContainer.addChild(score);

    const roundText = new createjs.Text(`ROUND ${roundNumber}`, "18px 'Press Start 2P'", '#fff');
    roundText.x = 270;
    roundText.y = 200;
